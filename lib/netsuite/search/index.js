...
Search.ContactSearchBasic = require('./contactSearchBasic');
Search.CostCategorySearch = require('./costCategorySearch');
...
Search.TaxGroupSearch = require('./taxGroupSearch');
Search.TaxTypeSearch = require('./taxTypeSearch');
